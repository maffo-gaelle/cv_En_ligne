let citations = [
    ...
    ["C’est souvent la dernière clef du trousseau qui ouvre la porte.", "Zig Ziglar"],
    ["Pour gagner une fortune, apprenez par vous-même.", "Brian Tracy"],
    ["Les gagnants trouvent des moyens, les perdants des excuses…", "F. D. Roosevelt"],
    ["Vous n’êtes jamais trop vieux pour vous fixer de nouveaux buts.", "C.S. Lewis"],
...
$(function() {
        ...
        $(".navbar__link a, footer a").on("click", function(e) {
            e.preventDefault();
            var hash = this.hash;
